...
public interface SysLogContentMapper {

    SysLogContent select(DataMap paramMap);
    
    List<SysLogContent> query(DataMap paramMap);
    
    int delete(DataMap paramMap);
    
    int deleteMultiple(DataMap paramMap);
    
    int insert(SysLogContent sysLogContent);
